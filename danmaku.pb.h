...
#ifndef GOOGLE_PROTOBUF_INCLUDED_danmaku_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_danmaku_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_danmaku_2eproto;
namespace bilibili {
namespace community {
namespace service {
namespace dm {
...
struct BuzzwordConfigDefaultTypeInternal;
extern BuzzwordConfigDefaultTypeInternal _BuzzwordConfig_default_instance_;
class BuzzwordShowConfig;
struct BuzzwordShowConfigDefaultTypeInternal;
extern BuzzwordShowConfigDefaultTypeInternal _BuzzwordShowConfig_default_instance_;
class CommandDm;
...
struct DmExpoReportReqDefaultTypeInternal;
extern DmExpoReportReqDefaultTypeInternal _DmExpoReportReq_default_instance_;
class DmExpoReportRes;
struct DmExpoReportResDefaultTypeInternal;
extern DmExpoReportResDefaultTypeInternal _DmExpoReportRes_default_instance_;
...
class ExpoReport;
struct ExpoReportDefaultTypeInternal;
extern ExpoReportDefaultTypeInternal _ExpoReport_default_instance_;
class Expression;
struct ExpressionDefaultTypeInternal;
extern ExpressionDefaultTypeInternal _Expression_default_instance_;
class Expressions;
struct ExpressionsDefaultTypeInternal;
extern ExpressionsDefaultTypeInternal _Expressions_default_instance_;
...
struct PlayerDanmakuSeniorModeSwitchDefaultTypeInternal;
extern PlayerDanmakuSeniorModeSwitchDefaultTypeInternal _PlayerDanmakuSeniorModeSwitch_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::bilibili::community::service::dm::v1::BuzzwordConfig* Arena::CreateMaybeMessage<::bilibili::community::service::dm::v1::BuzzwordConfig>(Arena*);
template<> ::bilibili::community::service::dm::v1::BuzzwordShowConfig* Arena::CreateMaybeMessage<::bilibili::community::service::dm::v1::BuzzwordShowConfig>(Arena*);
...
template<> ::bilibili::community::service::dm::v1::DmExpoReportReq* Arena::CreateMaybeMessage<::bilibili::community::service::dm::v1::DmExpoReportReq>(Arena*);
template<> ::bilibili::community::service::dm::v1::DmExpoReportRes* Arena::CreateMaybeMessage<::bilibili::community::service::dm::v1::DmExpoReportRes>(Arena*);
...
template<> ::bilibili::community::service::dm::v1::ExpoReport* Arena::CreateMaybeMessage<::bilibili::community::service::dm::v1::ExpoReport>(Arena*);
template<> ::bilibili::community::service::dm::v1::Expression* Arena::CreateMaybeMessage<::bilibili::community::service::dm::v1::Expression>(Arena*);
template<> ::bilibili::community::service::dm::v1::Expressions* Arena::CreateMaybeMessage<::bilibili::community::service::dm::v1::Expressions>(Arena*);
...
template<> ::bilibili::community::service::dm::v1::Period* Arena::CreateMaybeMessage<::bilibili::community::service::dm::v1::Period>(Arena*);
...
template<> ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* Arena::CreateMaybeMessage<::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch>(Arena*);
...
enum SubtitleType : int {
  CC = 0,
  AI = 1,
  SubtitleType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  SubtitleType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool SubtitleType_IsValid(int value);
constexpr SubtitleType SubtitleType_MIN = CC;
constexpr SubtitleType SubtitleType_MAX = AI;
constexpr int SubtitleType_ARRAYSIZE = SubtitleType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* SubtitleType_descriptor();
template<typename T>
inline const std::string& SubtitleType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, SubtitleType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function SubtitleType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    SubtitleType_descriptor(), enum_t_value);
}
inline bool SubtitleType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, SubtitleType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<SubtitleType>(
    SubtitleType_descriptor(), name, value);
}
// ===================================================================

class BuzzwordConfig final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bilibili.community.service.dm.v1.BuzzwordConfig) */ {
 public:
  inline BuzzwordConfig() : BuzzwordConfig(nullptr) {}
  ~BuzzwordConfig() override;
  explicit PROTOBUF_CONSTEXPR BuzzwordConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  BuzzwordConfig(const BuzzwordConfig& from);
  BuzzwordConfig(BuzzwordConfig&& from) noexcept
    : BuzzwordConfig() {
    *this = ::std::move(from);
  }

  inline BuzzwordConfig& operator=(const BuzzwordConfig& from) {
    CopyFrom(from);
    return *this;
  }
  inline BuzzwordConfig& operator=(BuzzwordConfig&& from) noexcept {
  ...
  static const BuzzwordConfig& default_instance() {
    return *internal_default_instance();
  }
  static inline const BuzzwordConfig* internal_default_instance() {
    return reinterpret_cast<const BuzzwordConfig*>(
               &_BuzzwordConfig_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(BuzzwordConfig& a, BuzzwordConfig& b) {
    a.Swap(&b);
  }
  inline void Swap(BuzzwordConfig* other) {
  ...
  void UnsafeArenaSwap(BuzzwordConfig* other) {
    if (other == this) return;
  ...
  BuzzwordConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<BuzzwordConfig>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const BuzzwordConfig& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const BuzzwordConfig& from) {
    BuzzwordConfig::MergeImpl(*this, from);
  }
  private:
  ...
  void InternalSwap(BuzzwordConfig* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bilibili.community.service.dm.v1.BuzzwordConfig";
  }
  protected:
  explicit BuzzwordConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  public:
  void clear_keywords();
  ::bilibili::community::service::dm::v1::BuzzwordShowConfig* mutable_keywords(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::BuzzwordShowConfig >*
      mutable_keywords();
  private:
  const ::bilibili::community::service::dm::v1::BuzzwordShowConfig& _internal_keywords(int index) const;
  ::bilibili::community::service::dm::v1::BuzzwordShowConfig* _internal_add_keywords();
  public:
  const ::bilibili::community::service::dm::v1::BuzzwordShowConfig& keywords(int index) const;
  ::bilibili::community::service::dm::v1::BuzzwordShowConfig* add_keywords();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::BuzzwordShowConfig >&
      keywords() const;
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::BuzzwordShowConfig > keywords_;
...
class BuzzwordShowConfig final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bilibili.community.service.dm.v1.BuzzwordShowConfig) */ {
 public:
  inline BuzzwordShowConfig() : BuzzwordShowConfig(nullptr) {}
  ~BuzzwordShowConfig() override;
  explicit PROTOBUF_CONSTEXPR BuzzwordShowConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  BuzzwordShowConfig(const BuzzwordShowConfig& from);
  BuzzwordShowConfig(BuzzwordShowConfig&& from) noexcept
    : BuzzwordShowConfig() {
    *this = ::std::move(from);
  }

  inline BuzzwordShowConfig& operator=(const BuzzwordShowConfig& from) {
    CopyFrom(from);
    return *this;
  }
  inline BuzzwordShowConfig& operator=(BuzzwordShowConfig&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const BuzzwordShowConfig& default_instance() {
    return *internal_default_instance();
  }
  static inline const BuzzwordShowConfig* internal_default_instance() {
    return reinterpret_cast<const BuzzwordShowConfig*>(
               &_BuzzwordShowConfig_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(BuzzwordShowConfig& a, BuzzwordShowConfig& b) {
    a.Swap(&b);
  }
  inline void Swap(BuzzwordShowConfig* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(BuzzwordShowConfig* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  BuzzwordShowConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<BuzzwordShowConfig>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const BuzzwordShowConfig& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const BuzzwordShowConfig& from) {
    BuzzwordShowConfig::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(BuzzwordShowConfig* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bilibili.community.service.dm.v1.BuzzwordShowConfig";
  }
  protected:
  explicit BuzzwordShowConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    ...
    kSchemaTypeFieldNumber = 6,
    kBuzzwordIdFieldNumber = 5,
  };
  // string name = 1;
  void clear_name();
  ...
  int32_t schema_type() const;
  void set_schema_type(int32_t value);
  private:
  int32_t _internal_schema_type() const;
  void _internal_set_schema_type(int32_t value);
  public:

  // int64 buzzword_id = 5;
  void clear_buzzword_id();
  int64_t buzzword_id() const;
  void set_buzzword_id(int64_t value);
  private:
  int64_t _internal_buzzword_id() const;
  void _internal_set_buzzword_id(int64_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    int64_t id_;
    int32_t source_;
    int32_t schema_type_;
    int64_t buzzword_id_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_danmaku_2eproto;
...
class DanmuDefaultPlayerConfig final :
 ...
 public:
  ...
  enum : int {
    ...
    kPlayerDanmakuSeniorModeSwitchFieldNumber = 17,
  };
  ...
  void clear_player_danmaku_senior_mode_switch();
  int32_t player_danmaku_senior_mode_switch() const;
  void set_player_danmaku_senior_mode_switch(int32_t value);
  private:
  int32_t _internal_player_danmaku_senior_mode_switch() const;
  void _internal_set_player_danmaku_senior_mode_switch(int32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    int32_t player_danmaku_senior_mode_switch_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_danmaku_2eproto;
...
class DanmuPlayerConfig final :
 ...
 public:
  ...
  enum : int {
    ...
    kPlayerDanmakuIosSwitchSaveFieldNumber = 19,
    kPlayerDanmakuSeniorModeSwitchFieldNumber = 20,
  };
  ...
  void clear_player_danmaku_ios_switch_save();
  int32_t player_danmaku_ios_switch_save() const;
  void set_player_danmaku_ios_switch_save(int32_t value);
  private:
  int32_t _internal_player_danmaku_ios_switch_save() const;
  void _internal_set_player_danmaku_ios_switch_save(int32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    int32_t player_danmaku_ios_switch_save_;
    int32_t player_danmaku_senior_mode_switch_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
class DanmuWebPlayerConfig final :
 ...
 public:
  ...
  enum : int {
    ...
    kSeniorModeSwitchFieldNumber = 21,
  };
  ...
  void clear_senior_mode_switch();
  int32_t senior_mode_switch() const;
  void set_senior_mode_switch(int32_t value);
  private:
  int32_t _internal_senior_mode_switch() const;
  void _internal_set_senior_mode_switch(int32_t value);
  public:
...
class DmExpoReportReq final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bilibili.community.service.dm.v1.DmExpoReportReq) */ {
 public:
  inline DmExpoReportReq() : DmExpoReportReq(nullptr) {}
  ~DmExpoReportReq() override;
  explicit PROTOBUF_CONSTEXPR DmExpoReportReq(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  DmExpoReportReq(const DmExpoReportReq& from);
  DmExpoReportReq(DmExpoReportReq&& from) noexcept
    : DmExpoReportReq() {
    *this = ::std::move(from);
  }

  inline DmExpoReportReq& operator=(const DmExpoReportReq& from) {
    CopyFrom(from);
    return *this;
  }
  inline DmExpoReportReq& operator=(DmExpoReportReq&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const DmExpoReportReq& default_instance() {
    return *internal_default_instance();
  }
  static inline const DmExpoReportReq* internal_default_instance() {
    return reinterpret_cast<const DmExpoReportReq*>(
               &_DmExpoReportReq_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(DmExpoReportReq& a, DmExpoReportReq& b) {
    a.Swap(&b);
  }
  inline void Swap(DmExpoReportReq* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(DmExpoReportReq* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  DmExpoReportReq* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<DmExpoReportReq>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const DmExpoReportReq& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const DmExpoReportReq& from) {
    DmExpoReportReq::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DmExpoReportReq* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bilibili.community.service.dm.v1.DmExpoReportReq";
  }
  protected:
  explicit DmExpoReportReq(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class DmExpoReportRes final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:bilibili.community.service.dm.v1.DmExpoReportRes) */ {
 public:
  inline DmExpoReportRes() : DmExpoReportRes(nullptr) {}
  explicit PROTOBUF_CONSTEXPR DmExpoReportRes(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  DmExpoReportRes(const DmExpoReportRes& from);
  DmExpoReportRes(DmExpoReportRes&& from) noexcept
    : DmExpoReportRes() {
    *this = ::std::move(from);
  }

  inline DmExpoReportRes& operator=(const DmExpoReportRes& from) {
    CopyFrom(from);
    return *this;
  }
  inline DmExpoReportRes& operator=(DmExpoReportRes&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const DmExpoReportRes& default_instance() {
    return *internal_default_instance();
  }
  static inline const DmExpoReportRes* internal_default_instance() {
    return reinterpret_cast<const DmExpoReportRes*>(
               &_DmExpoReportRes_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    13;

  friend void swap(DmExpoReportRes& a, DmExpoReportRes& b) {
    a.Swap(&b);
  }
  inline void Swap(DmExpoReportRes* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(DmExpoReportRes* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  DmExpoReportRes* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<DmExpoReportRes>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const DmExpoReportRes& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(const DmExpoReportRes& from) {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bilibili.community.service.dm.v1.DmExpoReportRes";
  }
  protected:
  explicit DmExpoReportRes(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class DmPlayerConfigReq final :
 ...
 public:
  ...
  enum : int {
    ...
    kSeniorModeSwitchFieldNumber = 19,
    kTsFieldNumber = 1,
  };
  ...
  bool has_senior_mode_switch() const;
  private:
  bool _internal_has_senior_mode_switch() const;
  public:
  void clear_senior_mode_switch();
  const ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch& senior_mode_switch() const;
  PROTOBUF_NODISCARD ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* release_senior_mode_switch();
  ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* mutable_senior_mode_switch();
  void set_allocated_senior_mode_switch(::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* senior_mode_switch);
  private:
  const ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch& _internal_senior_mode_switch() const;
  ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* _internal_mutable_senior_mode_switch();
  public:
  void unsafe_arena_set_allocated_senior_mode_switch(
      ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* senior_mode_switch);
  ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* unsafe_arena_release_senior_mode_switch();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* senior_mode_switch_;
    int64_t ts_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
class DmViewReply final :
 ...
 public:
  ...
  enum : int {
    ...
    kExpoReportFieldNumber = 14,
    kBuzzwordConfigFieldNumber = 15,
    kClosedFieldNumber = 1,
    kAllowFieldNumber = 8,
  ...
  ::bilibili::community::service::dm::v1::Expressions* mutable_expressions(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expressions >*
      mutable_expressions();
  private:
  const ::bilibili::community::service::dm::v1::Expressions& _internal_expressions(int index) const;
  ::bilibili::community::service::dm::v1::Expressions* _internal_add_expressions();
  public:
  const ::bilibili::community::service::dm::v1::Expressions& expressions(int index) const;
  ::bilibili::community::service::dm::v1::Expressions* add_expressions();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expressions >&
      expressions() const;
  ...
  bool has_expo_report() const;
  private:
  bool _internal_has_expo_report() const;
  public:
  void clear_expo_report();
  const ::bilibili::community::service::dm::v1::ExpoReport& expo_report() const;
  PROTOBUF_NODISCARD ::bilibili::community::service::dm::v1::ExpoReport* release_expo_report();
  ::bilibili::community::service::dm::v1::ExpoReport* mutable_expo_report();
  void set_allocated_expo_report(::bilibili::community::service::dm::v1::ExpoReport* expo_report);
  private:
  const ::bilibili::community::service::dm::v1::ExpoReport& _internal_expo_report() const;
  ::bilibili::community::service::dm::v1::ExpoReport* _internal_mutable_expo_report();
  public:
  void unsafe_arena_set_allocated_expo_report(
      ::bilibili::community::service::dm::v1::ExpoReport* expo_report);
  ::bilibili::community::service::dm::v1::ExpoReport* unsafe_arena_release_expo_report();

  // .bilibili.community.service.dm.v1.BuzzwordConfig buzzword_config = 15;
  bool has_buzzword_config() const;
  private:
  bool _internal_has_buzzword_config() const;
  public:
  void clear_buzzword_config();
  const ::bilibili::community::service::dm::v1::BuzzwordConfig& buzzword_config() const;
  PROTOBUF_NODISCARD ::bilibili::community::service::dm::v1::BuzzwordConfig* release_buzzword_config();
  ::bilibili::community::service::dm::v1::BuzzwordConfig* mutable_buzzword_config();
  void set_allocated_buzzword_config(::bilibili::community::service::dm::v1::BuzzwordConfig* buzzword_config);
  private:
  const ::bilibili::community::service::dm::v1::BuzzwordConfig& _internal_buzzword_config() const;
  ::bilibili::community::service::dm::v1::BuzzwordConfig* _internal_mutable_buzzword_config();
  public:
  void unsafe_arena_set_allocated_buzzword_config(
      ::bilibili::community::service::dm::v1::BuzzwordConfig* buzzword_config);
  ::bilibili::community::service::dm::v1::BuzzwordConfig* unsafe_arena_release_buzzword_config();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expressions > expressions_;
    ...
    ::bilibili::community::service::dm::v1::ExpoReport* expo_report_;
    ::bilibili::community::service::dm::v1::BuzzwordConfig* buzzword_config_;
    bool closed_;
    bool allow_;
...
class ExpoReport final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bilibili.community.service.dm.v1.ExpoReport) */ {
 public:
  inline ExpoReport() : ExpoReport(nullptr) {}
  ~ExpoReport() override;
  explicit PROTOBUF_CONSTEXPR ExpoReport(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ExpoReport(const ExpoReport& from);
  ExpoReport(ExpoReport&& from) noexcept
    : ExpoReport() {
    *this = ::std::move(from);
  }

  inline ExpoReport& operator=(const ExpoReport& from) {
    CopyFrom(from);
    return *this;
  }
  inline ExpoReport& operator=(ExpoReport&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ExpoReport& default_instance() {
    return *internal_default_instance();
  }
  static inline const ExpoReport* internal_default_instance() {
    return reinterpret_cast<const ExpoReport*>(
               &_ExpoReport_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    25;

  friend void swap(ExpoReport& a, ExpoReport& b) {
    a.Swap(&b);
  }
  inline void Swap(ExpoReport* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ExpoReport* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ExpoReport* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ExpoReport>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ExpoReport& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ExpoReport& from) {
    ExpoReport::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ExpoReport* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bilibili.community.service.dm.v1.ExpoReport";
  }
  protected:
  explicit ExpoReport(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kShouldReportAtEndFieldNumber = 1,
  };
  // bool should_report_at_end = 1;
  void clear_should_report_at_end();
  bool should_report_at_end() const;
  void set_should_report_at_end(bool value);
  private:
  bool _internal_should_report_at_end() const;
  void _internal_set_should_report_at_end(bool value);
  public:
...
class Expression final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bilibili.community.service.dm.v1.Expression) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bilibili.community.service.dm.v1.Expression";
  }
  protected:
  ...
  int keyword_size() const;
  private:
  int _internal_keyword_size() const;
  public:
  void clear_keyword();
  const std::string& keyword(int index) const;
  std::string* mutable_keyword(int index);
  void set_keyword(int index, const std::string& value);
  void set_keyword(int index, std::string&& value);
  void set_keyword(int index, const char* value);
  void set_keyword(int index, const char* value, size_t size);
  std::string* add_keyword();
  void add_keyword(const std::string& value);
  void add_keyword(std::string&& value);
  void add_keyword(const char* value);
  void add_keyword(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& keyword() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_keyword();
  private:
  const std::string& _internal_keyword(int index) const;
  std::string* _internal_add_keyword();
  public:
  ...
  public:
  void clear_period();
  ::bilibili::community::service::dm::v1::Period* mutable_period(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Period >*
      mutable_period();
  private:
  const ::bilibili::community::service::dm::v1::Period& _internal_period(int index) const;
  ::bilibili::community::service::dm::v1::Period* _internal_add_period();
  public:
  const ::bilibili::community::service::dm::v1::Period& period(int index) const;
  ::bilibili::community::service::dm::v1::Period* add_period();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Period >&
      period() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> keyword_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Period > period_;
...
class Expressions final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bilibili.community.service.dm.v1.Expressions) */ {
 public:
  inline Expressions() : Expressions(nullptr) {}
  ~Expressions() override;
  explicit PROTOBUF_CONSTEXPR Expressions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  Expressions(const Expressions& from);
  Expressions(Expressions&& from) noexcept
    : Expressions() {
    *this = ::std::move(from);
  }

  inline Expressions& operator=(const Expressions& from) {
    CopyFrom(from);
    return *this;
  }
  inline Expressions& operator=(Expressions&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const Expressions& default_instance() {
    return *internal_default_instance();
  }
  static inline const Expressions* internal_default_instance() {
    return reinterpret_cast<const Expressions*>(
               &_Expressions_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    27;

  friend void swap(Expressions& a, Expressions& b) {
    a.Swap(&b);
  }
  inline void Swap(Expressions* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(Expressions* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  Expressions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<Expressions>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const Expressions& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const Expressions& from) {
    Expressions::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Expressions* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bilibili.community.service.dm.v1.Expressions";
  }
  protected:
  explicit Expressions(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  public:
  void clear_data();
  ::bilibili::community::service::dm::v1::Expression* mutable_data(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expression >*
      mutable_data();
  private:
  const ::bilibili::community::service::dm::v1::Expression& _internal_data(int index) const;
  ::bilibili::community::service::dm::v1::Expression* _internal_add_data();
  public:
  const ::bilibili::community::service::dm::v1::Expression& data(int index) const;
  ::bilibili::community::service::dm::v1::Expression* add_data();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expression >&
      data() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expression > data_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_danmaku_2eproto;
...
class Period final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bilibili.community.service.dm.v1.Period) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bilibili.community.service.dm.v1.Period";
  }
  protected:
...
class PlayerDanmakuSeniorModeSwitch final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bilibili.community.service.dm.v1.PlayerDanmakuSeniorModeSwitch) */ {
 public:
  inline PlayerDanmakuSeniorModeSwitch() : PlayerDanmakuSeniorModeSwitch(nullptr) {}
  ~PlayerDanmakuSeniorModeSwitch() override;
  explicit PROTOBUF_CONSTEXPR PlayerDanmakuSeniorModeSwitch(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  PlayerDanmakuSeniorModeSwitch(const PlayerDanmakuSeniorModeSwitch& from);
  PlayerDanmakuSeniorModeSwitch(PlayerDanmakuSeniorModeSwitch&& from) noexcept
    : PlayerDanmakuSeniorModeSwitch() {
    *this = ::std::move(from);
  }

  inline PlayerDanmakuSeniorModeSwitch& operator=(const PlayerDanmakuSeniorModeSwitch& from) {
    CopyFrom(from);
    return *this;
  }
  inline PlayerDanmakuSeniorModeSwitch& operator=(PlayerDanmakuSeniorModeSwitch&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const PlayerDanmakuSeniorModeSwitch& default_instance() {
    return *internal_default_instance();
  }
  static inline const PlayerDanmakuSeniorModeSwitch* internal_default_instance() {
    return reinterpret_cast<const PlayerDanmakuSeniorModeSwitch*>(
               &_PlayerDanmakuSeniorModeSwitch_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    42;

  friend void swap(PlayerDanmakuSeniorModeSwitch& a, PlayerDanmakuSeniorModeSwitch& b) {
    a.Swap(&b);
  }
  inline void Swap(PlayerDanmakuSeniorModeSwitch* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(PlayerDanmakuSeniorModeSwitch* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  PlayerDanmakuSeniorModeSwitch* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<PlayerDanmakuSeniorModeSwitch>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const PlayerDanmakuSeniorModeSwitch& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const PlayerDanmakuSeniorModeSwitch& from) {
    PlayerDanmakuSeniorModeSwitch::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(PlayerDanmakuSeniorModeSwitch* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "bilibili.community.service.dm.v1.PlayerDanmakuSeniorModeSwitch";
  }
  protected:
  explicit PlayerDanmakuSeniorModeSwitch(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class SubtitleItem final :
 ...
 public:
  ...
  void clear_type();
  ::bilibili::community::service::dm::v1::SubtitleType type() const;
  void set_type(::bilibili::community::service::dm::v1::SubtitleType value);
  private:
  ::bilibili::community::service::dm::v1::SubtitleType _internal_type() const;
  void _internal_set_type(::bilibili::community::service::dm::v1::SubtitleType value);
  public:
...
// repeated .bilibili.community.service.dm.v1.BuzzwordShowConfig keywords = 1;
inline int BuzzwordConfig::_internal_keywords_size() const {
  return _impl_.keywords_.size();
}
inline int BuzzwordConfig::keywords_size() const {
  return _internal_keywords_size();
}
inline void BuzzwordConfig::clear_keywords() {
  _impl_.keywords_.Clear();
}
inline ::bilibili::community::service::dm::v1::BuzzwordShowConfig* BuzzwordConfig::mutable_keywords(int index) {
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.BuzzwordConfig.keywords)
  return _impl_.keywords_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::BuzzwordShowConfig >*
BuzzwordConfig::mutable_keywords() {
  // @@protoc_insertion_point(field_mutable_list:bilibili.community.service.dm.v1.BuzzwordConfig.keywords)
  return &_impl_.keywords_;
}
inline const ::bilibili::community::service::dm::v1::BuzzwordShowConfig& BuzzwordConfig::_internal_keywords(int index) const {
  return _impl_.keywords_.Get(index);
}
inline const ::bilibili::community::service::dm::v1::BuzzwordShowConfig& BuzzwordConfig::keywords(int index) const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.BuzzwordConfig.keywords)
  return _internal_keywords(index);
}
inline ::bilibili::community::service::dm::v1::BuzzwordShowConfig* BuzzwordConfig::_internal_add_keywords() {
  return _impl_.keywords_.Add();
}
inline ::bilibili::community::service::dm::v1::BuzzwordShowConfig* BuzzwordConfig::add_keywords() {
  ::bilibili::community::service::dm::v1::BuzzwordShowConfig* _add = _internal_add_keywords();
  // @@protoc_insertion_point(field_add:bilibili.community.service.dm.v1.BuzzwordConfig.keywords)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::BuzzwordShowConfig >&
BuzzwordConfig::keywords() const {
  // @@protoc_insertion_point(field_list:bilibili.community.service.dm.v1.BuzzwordConfig.keywords)
  return _impl_.keywords_;
}
...
// string name = 1;
inline void BuzzwordShowConfig::clear_name() {
  _impl_.name_.ClearToEmpty();
}
inline const std::string& BuzzwordShowConfig::name() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.BuzzwordShowConfig.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void BuzzwordShowConfig::set_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.BuzzwordShowConfig.name)
}
inline std::string* BuzzwordShowConfig::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.BuzzwordShowConfig.name)
  return _s;
}
inline const std::string& BuzzwordShowConfig::_internal_name() const {
  return _impl_.name_.Get();
}
inline void BuzzwordShowConfig::_internal_set_name(const std::string& value) {
  
  _impl_.name_.Set(value, GetArenaForAllocation());
}
inline std::string* BuzzwordShowConfig::_internal_mutable_name() {
  
  return _impl_.name_.Mutable(GetArenaForAllocation());
}
inline std::string* BuzzwordShowConfig::release_name() {
  // @@protoc_insertion_point(field_release:bilibili.community.service.dm.v1.BuzzwordShowConfig.name)
  return _impl_.name_.Release();
}
inline void BuzzwordShowConfig::set_allocated_name(std::string* name) {
  if (name != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:bilibili.community.service.dm.v1.BuzzwordShowConfig.name)
}

// string schema = 2;
inline void BuzzwordShowConfig::clear_schema() {
  _impl_.schema_.ClearToEmpty();
}
inline const std::string& BuzzwordShowConfig::schema() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.BuzzwordShowConfig.schema)
  return _internal_schema();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void BuzzwordShowConfig::set_schema(ArgT0&& arg0, ArgT... args) {
 
 _impl_.schema_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.BuzzwordShowConfig.schema)
}
inline std::string* BuzzwordShowConfig::mutable_schema() {
  std::string* _s = _internal_mutable_schema();
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.BuzzwordShowConfig.schema)
  return _s;
}
inline const std::string& BuzzwordShowConfig::_internal_schema() const {
  return _impl_.schema_.Get();
}
inline void BuzzwordShowConfig::_internal_set_schema(const std::string& value) {
  
  _impl_.schema_.Set(value, GetArenaForAllocation());
}
inline std::string* BuzzwordShowConfig::_internal_mutable_schema() {
  
  return _impl_.schema_.Mutable(GetArenaForAllocation());
}
inline std::string* BuzzwordShowConfig::release_schema() {
  // @@protoc_insertion_point(field_release:bilibili.community.service.dm.v1.BuzzwordShowConfig.schema)
  return _impl_.schema_.Release();
}
inline void BuzzwordShowConfig::set_allocated_schema(std::string* schema) {
  if (schema != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:bilibili.community.service.dm.v1.BuzzwordShowConfig.schema)
}

// int32 source = 3;
inline void BuzzwordShowConfig::clear_source() {
  _impl_.source_ = 0;
}
inline int32_t BuzzwordShowConfig::_internal_source() const {
  return _impl_.source_;
}
inline int32_t BuzzwordShowConfig::source() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.BuzzwordShowConfig.source)
  return _internal_source();
}
inline void BuzzwordShowConfig::_internal_set_source(int32_t value) {
  
  _impl_.source_ = value;
}
inline void BuzzwordShowConfig::set_source(int32_t value) {
  _internal_set_source(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.BuzzwordShowConfig.source)
}

// int64 id = 4;
inline void BuzzwordShowConfig::clear_id() {
  _impl_.id_ = int64_t{0};
}
inline int64_t BuzzwordShowConfig::_internal_id() const {
  return _impl_.id_;
}
inline int64_t BuzzwordShowConfig::id() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.BuzzwordShowConfig.id)
  return _internal_id();
}
inline void BuzzwordShowConfig::_internal_set_id(int64_t value) {
  
  _impl_.id_ = value;
}
inline void BuzzwordShowConfig::set_id(int64_t value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.BuzzwordShowConfig.id)
}

// int64 buzzword_id = 5;
inline void BuzzwordShowConfig::clear_buzzword_id() {
  _impl_.buzzword_id_ = int64_t{0};
}
inline int64_t BuzzwordShowConfig::_internal_buzzword_id() const {
  return _impl_.buzzword_id_;
}
inline int64_t BuzzwordShowConfig::buzzword_id() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.BuzzwordShowConfig.buzzword_id)
  return _internal_buzzword_id();
}
inline void BuzzwordShowConfig::_internal_set_buzzword_id(int64_t value) {
  
  _impl_.buzzword_id_ = value;
}
inline void BuzzwordShowConfig::set_buzzword_id(int64_t value) {
  _internal_set_buzzword_id(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.BuzzwordShowConfig.buzzword_id)
}

// int32 schema_type = 6;
inline void BuzzwordShowConfig::clear_schema_type() {
  _impl_.schema_type_ = 0;
}
inline int32_t BuzzwordShowConfig::_internal_schema_type() const {
  return _impl_.schema_type_;
}
inline int32_t BuzzwordShowConfig::schema_type() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.BuzzwordShowConfig.schema_type)
  return _internal_schema_type();
}
inline void BuzzwordShowConfig::_internal_set_schema_type(int32_t value) {
  
  _impl_.schema_type_ = value;
}
inline void BuzzwordShowConfig::set_schema_type(int32_t value) {
  _internal_set_schema_type(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.BuzzwordShowConfig.schema_type)
}
...
// int32 player_danmaku_senior_mode_switch = 17;
inline void DanmuDefaultPlayerConfig::clear_player_danmaku_senior_mode_switch() {
  _impl_.player_danmaku_senior_mode_switch_ = 0;
}
inline int32_t DanmuDefaultPlayerConfig::_internal_player_danmaku_senior_mode_switch() const {
  return _impl_.player_danmaku_senior_mode_switch_;
}
inline int32_t DanmuDefaultPlayerConfig::player_danmaku_senior_mode_switch() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DanmuDefaultPlayerConfig.player_danmaku_senior_mode_switch)
  return _internal_player_danmaku_senior_mode_switch();
}
inline void DanmuDefaultPlayerConfig::_internal_set_player_danmaku_senior_mode_switch(int32_t value) {
  
  _impl_.player_danmaku_senior_mode_switch_ = value;
}
inline void DanmuDefaultPlayerConfig::set_player_danmaku_senior_mode_switch(int32_t value) {
  _internal_set_player_danmaku_senior_mode_switch(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.DanmuDefaultPlayerConfig.player_danmaku_senior_mode_switch)
}
...
// int32 player_danmaku_ios_switch_save = 19;
inline void DanmuPlayerConfig::clear_player_danmaku_ios_switch_save() {
  _impl_.player_danmaku_ios_switch_save_ = 0;
}
inline int32_t DanmuPlayerConfig::_internal_player_danmaku_ios_switch_save() const {
  return _impl_.player_danmaku_ios_switch_save_;
}
inline int32_t DanmuPlayerConfig::player_danmaku_ios_switch_save() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DanmuPlayerConfig.player_danmaku_ios_switch_save)
  return _internal_player_danmaku_ios_switch_save();
}
inline void DanmuPlayerConfig::_internal_set_player_danmaku_ios_switch_save(int32_t value) {
  
  _impl_.player_danmaku_ios_switch_save_ = value;
}
inline void DanmuPlayerConfig::set_player_danmaku_ios_switch_save(int32_t value) {
  _internal_set_player_danmaku_ios_switch_save(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.DanmuPlayerConfig.player_danmaku_ios_switch_save)
}

// int32 player_danmaku_senior_mode_switch = 20;
inline void DanmuPlayerConfig::clear_player_danmaku_senior_mode_switch() {
  _impl_.player_danmaku_senior_mode_switch_ = 0;
}
inline int32_t DanmuPlayerConfig::_internal_player_danmaku_senior_mode_switch() const {
  return _impl_.player_danmaku_senior_mode_switch_;
}
inline int32_t DanmuPlayerConfig::player_danmaku_senior_mode_switch() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DanmuPlayerConfig.player_danmaku_senior_mode_switch)
  return _internal_player_danmaku_senior_mode_switch();
}
inline void DanmuPlayerConfig::_internal_set_player_danmaku_senior_mode_switch(int32_t value) {
  
  _impl_.player_danmaku_senior_mode_switch_ = value;
}
inline void DanmuPlayerConfig::set_player_danmaku_senior_mode_switch(int32_t value) {
  _internal_set_player_danmaku_senior_mode_switch(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.DanmuPlayerConfig.player_danmaku_senior_mode_switch)
}
...
// int32 senior_mode_switch = 21;
inline void DanmuWebPlayerConfig::clear_senior_mode_switch() {
  _impl_.senior_mode_switch_ = 0;
}
inline int32_t DanmuWebPlayerConfig::_internal_senior_mode_switch() const {
  return _impl_.senior_mode_switch_;
}
inline int32_t DanmuWebPlayerConfig::senior_mode_switch() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DanmuWebPlayerConfig.senior_mode_switch)
  return _internal_senior_mode_switch();
}
inline void DanmuWebPlayerConfig::_internal_set_senior_mode_switch(int32_t value) {
  
  _impl_.senior_mode_switch_ = value;
}
inline void DanmuWebPlayerConfig::set_senior_mode_switch(int32_t value) {
  _internal_set_senior_mode_switch(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.DanmuWebPlayerConfig.senior_mode_switch)
}
...
// string session_id = 1;
inline void DmExpoReportReq::clear_session_id() {
  _impl_.session_id_.ClearToEmpty();
}
inline const std::string& DmExpoReportReq::session_id() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DmExpoReportReq.session_id)
  return _internal_session_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DmExpoReportReq::set_session_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.session_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.DmExpoReportReq.session_id)
}
inline std::string* DmExpoReportReq::mutable_session_id() {
  std::string* _s = _internal_mutable_session_id();
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.DmExpoReportReq.session_id)
  return _s;
}
inline const std::string& DmExpoReportReq::_internal_session_id() const {
  return _impl_.session_id_.Get();
}
inline void DmExpoReportReq::_internal_set_session_id(const std::string& value) {
  
  _impl_.session_id_.Set(value, GetArenaForAllocation());
}
inline std::string* DmExpoReportReq::_internal_mutable_session_id() {
  
  return _impl_.session_id_.Mutable(GetArenaForAllocation());
}
inline std::string* DmExpoReportReq::release_session_id() {
  // @@protoc_insertion_point(field_release:bilibili.community.service.dm.v1.DmExpoReportReq.session_id)
  return _impl_.session_id_.Release();
}
inline void DmExpoReportReq::set_allocated_session_id(std::string* session_id) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:bilibili.community.service.dm.v1.DmExpoReportReq.session_id)
}

// int64 oid = 2;
inline void DmExpoReportReq::clear_oid() {
  _impl_.oid_ = int64_t{0};
}
inline int64_t DmExpoReportReq::_internal_oid() const {
  return _impl_.oid_;
}
inline int64_t DmExpoReportReq::oid() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DmExpoReportReq.oid)
  return _internal_oid();
}
inline void DmExpoReportReq::_internal_set_oid(int64_t value) {
  
  _impl_.oid_ = value;
}
inline void DmExpoReportReq::set_oid(int64_t value) {
  _internal_set_oid(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.DmExpoReportReq.oid)
}

// string spmid = 4;
inline void DmExpoReportReq::clear_spmid() {
  _impl_.spmid_.ClearToEmpty();
}
inline const std::string& DmExpoReportReq::spmid() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DmExpoReportReq.spmid)
  return _internal_spmid();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DmExpoReportReq::set_spmid(ArgT0&& arg0, ArgT... args) {
 
 _impl_.spmid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.DmExpoReportReq.spmid)
}
inline std::string* DmExpoReportReq::mutable_spmid() {
  std::string* _s = _internal_mutable_spmid();
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.DmExpoReportReq.spmid)
  return _s;
}
inline const std::string& DmExpoReportReq::_internal_spmid() const {
  return _impl_.spmid_.Get();
}
inline void DmExpoReportReq::_internal_set_spmid(const std::string& value) {
  
  _impl_.spmid_.Set(value, GetArenaForAllocation());
}
inline std::string* DmExpoReportReq::_internal_mutable_spmid() {
  
  return _impl_.spmid_.Mutable(GetArenaForAllocation());
}
inline std::string* DmExpoReportReq::release_spmid() {
  // @@protoc_insertion_point(field_release:bilibili.community.service.dm.v1.DmExpoReportReq.spmid)
  return _impl_.spmid_.Release();
}
inline void DmExpoReportReq::set_allocated_spmid(std::string* spmid) {
  if (spmid != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:bilibili.community.service.dm.v1.DmExpoReportReq.spmid)
}
...
// .bilibili.community.service.dm.v1.PlayerDanmakuSeniorModeSwitch senior_mode_switch = 19;
inline bool DmPlayerConfigReq::_internal_has_senior_mode_switch() const {
  return this != internal_default_instance() && _impl_.senior_mode_switch_ != nullptr;
}
inline bool DmPlayerConfigReq::has_senior_mode_switch() const {
  return _internal_has_senior_mode_switch();
}
inline void DmPlayerConfigReq::clear_senior_mode_switch() {
  if (GetArenaForAllocation() == nullptr && _impl_.senior_mode_switch_ != nullptr) {
    delete _impl_.senior_mode_switch_;
  }
  _impl_.senior_mode_switch_ = nullptr;
}
inline const ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch& DmPlayerConfigReq::_internal_senior_mode_switch() const {
  const ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* p = _impl_.senior_mode_switch_;
  return p != nullptr ? *p : reinterpret_cast<const ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch&>(
      ::bilibili::community::service::dm::v1::_PlayerDanmakuSeniorModeSwitch_default_instance_);
}
inline const ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch& DmPlayerConfigReq::senior_mode_switch() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DmPlayerConfigReq.senior_mode_switch)
  return _internal_senior_mode_switch();
}
inline void DmPlayerConfigReq::unsafe_arena_set_allocated_senior_mode_switch(
    ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* senior_mode_switch) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.senior_mode_switch_);
  }
  _impl_.senior_mode_switch_ = senior_mode_switch;
  if (senior_mode_switch) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:bilibili.community.service.dm.v1.DmPlayerConfigReq.senior_mode_switch)
}
inline ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* DmPlayerConfigReq::release_senior_mode_switch() {
  
  ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* temp = _impl_.senior_mode_switch_;
  _impl_.senior_mode_switch_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* DmPlayerConfigReq::unsafe_arena_release_senior_mode_switch() {
  // @@protoc_insertion_point(field_release:bilibili.community.service.dm.v1.DmPlayerConfigReq.senior_mode_switch)
  
  ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* temp = _impl_.senior_mode_switch_;
  _impl_.senior_mode_switch_ = nullptr;
  return temp;
}
inline ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* DmPlayerConfigReq::_internal_mutable_senior_mode_switch() {
  
  if (_impl_.senior_mode_switch_ == nullptr) {
    auto* p = CreateMaybeMessage<::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch>(GetArenaForAllocation());
    _impl_.senior_mode_switch_ = p;
  }
  return _impl_.senior_mode_switch_;
}
inline ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* DmPlayerConfigReq::mutable_senior_mode_switch() {
  ::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* _msg = _internal_mutable_senior_mode_switch();
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.DmPlayerConfigReq.senior_mode_switch)
  return _msg;
}
inline void DmPlayerConfigReq::set_allocated_senior_mode_switch(::bilibili::community::service::dm::v1::PlayerDanmakuSeniorModeSwitch* senior_mode_switch) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.senior_mode_switch_;
  }
  if (senior_mode_switch) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(senior_mode_switch);
    if (message_arena != submessage_arena) {
      senior_mode_switch = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, senior_mode_switch, submessage_arena);
    }
  ...
  _impl_.senior_mode_switch_ = senior_mode_switch;
  // @@protoc_insertion_point(field_set_allocated:bilibili.community.service.dm.v1.DmPlayerConfigReq.senior_mode_switch)
}
...
// .bilibili.community.service.dm.v1.ExpoReport expo_report = 14;
inline bool DmViewReply::_internal_has_expo_report() const {
  return this != internal_default_instance() && _impl_.expo_report_ != nullptr;
}
inline bool DmViewReply::has_expo_report() const {
  return _internal_has_expo_report();
}
inline void DmViewReply::clear_expo_report() {
  if (GetArenaForAllocation() == nullptr && _impl_.expo_report_ != nullptr) {
    delete _impl_.expo_report_;
  }
  _impl_.expo_report_ = nullptr;
}
inline const ::bilibili::community::service::dm::v1::ExpoReport& DmViewReply::_internal_expo_report() const {
  const ::bilibili::community::service::dm::v1::ExpoReport* p = _impl_.expo_report_;
  return p != nullptr ? *p : reinterpret_cast<const ::bilibili::community::service::dm::v1::ExpoReport&>(
      ::bilibili::community::service::dm::v1::_ExpoReport_default_instance_);
}
inline const ::bilibili::community::service::dm::v1::ExpoReport& DmViewReply::expo_report() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DmViewReply.expo_report)
  return _internal_expo_report();
}
inline void DmViewReply::unsafe_arena_set_allocated_expo_report(
    ::bilibili::community::service::dm::v1::ExpoReport* expo_report) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.expo_report_);
  }
  _impl_.expo_report_ = expo_report;
  if (expo_report) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:bilibili.community.service.dm.v1.DmViewReply.expo_report)
}
inline ::bilibili::community::service::dm::v1::ExpoReport* DmViewReply::release_expo_report() {
  
  ::bilibili::community::service::dm::v1::ExpoReport* temp = _impl_.expo_report_;
  _impl_.expo_report_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::bilibili::community::service::dm::v1::ExpoReport* DmViewReply::unsafe_arena_release_expo_report() {
  // @@protoc_insertion_point(field_release:bilibili.community.service.dm.v1.DmViewReply.expo_report)
  
  ::bilibili::community::service::dm::v1::ExpoReport* temp = _impl_.expo_report_;
  _impl_.expo_report_ = nullptr;
  return temp;
}
inline ::bilibili::community::service::dm::v1::ExpoReport* DmViewReply::_internal_mutable_expo_report() {
  
  if (_impl_.expo_report_ == nullptr) {
    auto* p = CreateMaybeMessage<::bilibili::community::service::dm::v1::ExpoReport>(GetArenaForAllocation());
    _impl_.expo_report_ = p;
  }
  return _impl_.expo_report_;
}
inline ::bilibili::community::service::dm::v1::ExpoReport* DmViewReply::mutable_expo_report() {
  ::bilibili::community::service::dm::v1::ExpoReport* _msg = _internal_mutable_expo_report();
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.DmViewReply.expo_report)
  return _msg;
}
inline void DmViewReply::set_allocated_expo_report(::bilibili::community::service::dm::v1::ExpoReport* expo_report) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.expo_report_;
  }
  if (expo_report) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(expo_report);
    if (message_arena != submessage_arena) {
      expo_report = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, expo_report, submessage_arena);
    }
  ...
  _impl_.expo_report_ = expo_report;
  // @@protoc_insertion_point(field_set_allocated:bilibili.community.service.dm.v1.DmViewReply.expo_report)
}

// .bilibili.community.service.dm.v1.BuzzwordConfig buzzword_config = 15;
inline bool DmViewReply::_internal_has_buzzword_config() const {
  return this != internal_default_instance() && _impl_.buzzword_config_ != nullptr;
}
inline bool DmViewReply::has_buzzword_config() const {
  return _internal_has_buzzword_config();
}
inline void DmViewReply::clear_buzzword_config() {
  if (GetArenaForAllocation() == nullptr && _impl_.buzzword_config_ != nullptr) {
    delete _impl_.buzzword_config_;
  }
  _impl_.buzzword_config_ = nullptr;
}
inline const ::bilibili::community::service::dm::v1::BuzzwordConfig& DmViewReply::_internal_buzzword_config() const {
  const ::bilibili::community::service::dm::v1::BuzzwordConfig* p = _impl_.buzzword_config_;
  return p != nullptr ? *p : reinterpret_cast<const ::bilibili::community::service::dm::v1::BuzzwordConfig&>(
      ::bilibili::community::service::dm::v1::_BuzzwordConfig_default_instance_);
}
inline const ::bilibili::community::service::dm::v1::BuzzwordConfig& DmViewReply::buzzword_config() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DmViewReply.buzzword_config)
  return _internal_buzzword_config();
}
inline void DmViewReply::unsafe_arena_set_allocated_buzzword_config(
    ::bilibili::community::service::dm::v1::BuzzwordConfig* buzzword_config) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.buzzword_config_);
  }
  _impl_.buzzword_config_ = buzzword_config;
  if (buzzword_config) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:bilibili.community.service.dm.v1.DmViewReply.buzzword_config)
}
inline ::bilibili::community::service::dm::v1::BuzzwordConfig* DmViewReply::release_buzzword_config() {
  
  ::bilibili::community::service::dm::v1::BuzzwordConfig* temp = _impl_.buzzword_config_;
  _impl_.buzzword_config_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::bilibili::community::service::dm::v1::BuzzwordConfig* DmViewReply::unsafe_arena_release_buzzword_config() {
  // @@protoc_insertion_point(field_release:bilibili.community.service.dm.v1.DmViewReply.buzzword_config)
  
  ::bilibili::community::service::dm::v1::BuzzwordConfig* temp = _impl_.buzzword_config_;
  _impl_.buzzword_config_ = nullptr;
  return temp;
}
inline ::bilibili::community::service::dm::v1::BuzzwordConfig* DmViewReply::_internal_mutable_buzzword_config() {
  
  if (_impl_.buzzword_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::bilibili::community::service::dm::v1::BuzzwordConfig>(GetArenaForAllocation());
    _impl_.buzzword_config_ = p;
  }
  return _impl_.buzzword_config_;
}
inline ::bilibili::community::service::dm::v1::BuzzwordConfig* DmViewReply::mutable_buzzword_config() {
  ::bilibili::community::service::dm::v1::BuzzwordConfig* _msg = _internal_mutable_buzzword_config();
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.DmViewReply.buzzword_config)
  return _msg;
}
inline void DmViewReply::set_allocated_buzzword_config(::bilibili::community::service::dm::v1::BuzzwordConfig* buzzword_config) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.buzzword_config_;
  }
  if (buzzword_config) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(buzzword_config);
    if (message_arena != submessage_arena) {
      buzzword_config = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, buzzword_config, submessage_arena);
    }
  ...
  _impl_.buzzword_config_ = buzzword_config;
  // @@protoc_insertion_point(field_set_allocated:bilibili.community.service.dm.v1.DmViewReply.buzzword_config)
}

// repeated .bilibili.community.service.dm.v1.Expressions expressions = 16;
inline int DmViewReply::_internal_expressions_size() const {
  return _impl_.expressions_.size();
}
inline int DmViewReply::expressions_size() const {
  return _internal_expressions_size();
}
inline void DmViewReply::clear_expressions() {
  _impl_.expressions_.Clear();
}
inline ::bilibili::community::service::dm::v1::Expressions* DmViewReply::mutable_expressions(int index) {
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.DmViewReply.expressions)
  return _impl_.expressions_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expressions >*
DmViewReply::mutable_expressions() {
  // @@protoc_insertion_point(field_mutable_list:bilibili.community.service.dm.v1.DmViewReply.expressions)
  return &_impl_.expressions_;
}
inline const ::bilibili::community::service::dm::v1::Expressions& DmViewReply::_internal_expressions(int index) const {
  return _impl_.expressions_.Get(index);
}
inline const ::bilibili::community::service::dm::v1::Expressions& DmViewReply::expressions(int index) const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DmViewReply.expressions)
  return _internal_expressions(index);
}
inline ::bilibili::community::service::dm::v1::Expressions* DmViewReply::_internal_add_expressions() {
  return _impl_.expressions_.Add();
}
inline ::bilibili::community::service::dm::v1::Expressions* DmViewReply::add_expressions() {
  ::bilibili::community::service::dm::v1::Expressions* _add = _internal_add_expressions();
  // @@protoc_insertion_point(field_add:bilibili.community.service.dm.v1.DmViewReply.expressions)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expressions >&
DmViewReply::expressions() const {
  // @@protoc_insertion_point(field_list:bilibili.community.service.dm.v1.DmViewReply.expressions)
  return _impl_.expressions_;
}
...
// repeated .bilibili.community.service.dm.v1.Expressions expressions = 12;
inline int DmWebViewReply::_internal_expressions_size() const {
  return _impl_.expressions_.size();
}
inline int DmWebViewReply::expressions_size() const {
  return _internal_expressions_size();
}
inline void DmWebViewReply::clear_expressions() {
  _impl_.expressions_.Clear();
}
inline ::bilibili::community::service::dm::v1::Expressions* DmWebViewReply::mutable_expressions(int index) {
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.DmWebViewReply.expressions)
  return _impl_.expressions_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expressions >*
DmWebViewReply::mutable_expressions() {
  // @@protoc_insertion_point(field_mutable_list:bilibili.community.service.dm.v1.DmWebViewReply.expressions)
  return &_impl_.expressions_;
}
inline const ::bilibili::community::service::dm::v1::Expressions& DmWebViewReply::_internal_expressions(int index) const {
  return _impl_.expressions_.Get(index);
}
inline const ::bilibili::community::service::dm::v1::Expressions& DmWebViewReply::expressions(int index) const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.DmWebViewReply.expressions)
  return _internal_expressions(index);
}
inline ::bilibili::community::service::dm::v1::Expressions* DmWebViewReply::_internal_add_expressions() {
  return _impl_.expressions_.Add();
}
inline ::bilibili::community::service::dm::v1::Expressions* DmWebViewReply::add_expressions() {
  ::bilibili::community::service::dm::v1::Expressions* _add = _internal_add_expressions();
  // @@protoc_insertion_point(field_add:bilibili.community.service.dm.v1.DmWebViewReply.expressions)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expressions >&
DmWebViewReply::expressions() const {
  // @@protoc_insertion_point(field_list:bilibili.community.service.dm.v1.DmWebViewReply.expressions)
  return _impl_.expressions_;
}
...
// bool should_report_at_end = 1;
inline void ExpoReport::clear_should_report_at_end() {
  _impl_.should_report_at_end_ = false;
}
inline bool ExpoReport::_internal_should_report_at_end() const {
  return _impl_.should_report_at_end_;
}
inline bool ExpoReport::should_report_at_end() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.ExpoReport.should_report_at_end)
  return _internal_should_report_at_end();
}
inline void ExpoReport::_internal_set_should_report_at_end(bool value) {
  
  _impl_.should_report_at_end_ = value;
}
inline void ExpoReport::set_should_report_at_end(bool value) {
  _internal_set_should_report_at_end(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.ExpoReport.should_report_at_end)
}
...
// repeated string keyword = 1;
inline int Expression::_internal_keyword_size() const {
  return _impl_.keyword_.size();
}
inline int Expression::keyword_size() const {
  return _internal_keyword_size();
}
inline void Expression::clear_keyword() {
  _impl_.keyword_.Clear();
}
inline std::string* Expression::add_keyword() {
  std::string* _s = _internal_add_keyword();
  // @@protoc_insertion_point(field_add_mutable:bilibili.community.service.dm.v1.Expression.keyword)
  return _s;
}
inline const std::string& Expression::_internal_keyword(int index) const {
  return _impl_.keyword_.Get(index);
}
inline const std::string& Expression::keyword(int index) const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.Expression.keyword)
  return _internal_keyword(index);
}
inline std::string* Expression::mutable_keyword(int index) {
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.Expression.keyword)
  return _impl_.keyword_.Mutable(index);
}
inline void Expression::set_keyword(int index, const std::string& value) {
  _impl_.keyword_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.Expression.keyword)
}
inline void Expression::set_keyword(int index, std::string&& value) {
  _impl_.keyword_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.Expression.keyword)
}
inline void Expression::set_keyword(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.keyword_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:bilibili.community.service.dm.v1.Expression.keyword)
}
inline void Expression::set_keyword(int index, const char* value, size_t size) {
  _impl_.keyword_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:bilibili.community.service.dm.v1.Expression.keyword)
}
inline std::string* Expression::_internal_add_keyword() {
  return _impl_.keyword_.Add();
}
inline void Expression::add_keyword(const std::string& value) {
  _impl_.keyword_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:bilibili.community.service.dm.v1.Expression.keyword)
}
inline void Expression::add_keyword(std::string&& value) {
  _impl_.keyword_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:bilibili.community.service.dm.v1.Expression.keyword)
}
inline void Expression::add_keyword(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.keyword_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:bilibili.community.service.dm.v1.Expression.keyword)
}
inline void Expression::add_keyword(const char* value, size_t size) {
  _impl_.keyword_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:bilibili.community.service.dm.v1.Expression.keyword)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Expression::keyword() const {
  // @@protoc_insertion_point(field_list:bilibili.community.service.dm.v1.Expression.keyword)
  return _impl_.keyword_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Expression::mutable_keyword() {
  // @@protoc_insertion_point(field_mutable_list:bilibili.community.service.dm.v1.Expression.keyword)
  return &_impl_.keyword_;
}

// string url = 2;
inline void Expression::clear_url() {
  _impl_.url_.ClearToEmpty();
}
inline const std::string& Expression::url() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.Expression.url)
  return _internal_url();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Expression::set_url(ArgT0&& arg0, ArgT... args) {
 
 _impl_.url_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.Expression.url)
}
inline std::string* Expression::mutable_url() {
  std::string* _s = _internal_mutable_url();
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.Expression.url)
  return _s;
}
inline const std::string& Expression::_internal_url() const {
  return _impl_.url_.Get();
}
inline void Expression::_internal_set_url(const std::string& value) {
  
  _impl_.url_.Set(value, GetArenaForAllocation());
}
inline std::string* Expression::_internal_mutable_url() {
  
  return _impl_.url_.Mutable(GetArenaForAllocation());
}
inline std::string* Expression::release_url() {
  // @@protoc_insertion_point(field_release:bilibili.community.service.dm.v1.Expression.url)
  return _impl_.url_.Release();
}
inline void Expression::set_allocated_url(std::string* url) {
  if (url != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:bilibili.community.service.dm.v1.Expression.url)
}

// repeated .bilibili.community.service.dm.v1.Period period = 3;
inline int Expression::_internal_period_size() const {
  return _impl_.period_.size();
}
inline int Expression::period_size() const {
  return _internal_period_size();
}
inline void Expression::clear_period() {
  _impl_.period_.Clear();
}
inline ::bilibili::community::service::dm::v1::Period* Expression::mutable_period(int index) {
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.Expression.period)
  return _impl_.period_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Period >*
Expression::mutable_period() {
  // @@protoc_insertion_point(field_mutable_list:bilibili.community.service.dm.v1.Expression.period)
  return &_impl_.period_;
}
inline const ::bilibili::community::service::dm::v1::Period& Expression::_internal_period(int index) const {
  return _impl_.period_.Get(index);
}
inline const ::bilibili::community::service::dm::v1::Period& Expression::period(int index) const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.Expression.period)
  return _internal_period(index);
}
inline ::bilibili::community::service::dm::v1::Period* Expression::_internal_add_period() {
  return _impl_.period_.Add();
}
inline ::bilibili::community::service::dm::v1::Period* Expression::add_period() {
  ::bilibili::community::service::dm::v1::Period* _add = _internal_add_period();
  // @@protoc_insertion_point(field_add:bilibili.community.service.dm.v1.Expression.period)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Period >&
Expression::period() const {
  // @@protoc_insertion_point(field_list:bilibili.community.service.dm.v1.Expression.period)
  return _impl_.period_;
}
...
// repeated .bilibili.community.service.dm.v1.Expression data = 1;
inline int Expressions::_internal_data_size() const {
  return _impl_.data_.size();
}
inline int Expressions::data_size() const {
  return _internal_data_size();
}
inline void Expressions::clear_data() {
  _impl_.data_.Clear();
}
inline ::bilibili::community::service::dm::v1::Expression* Expressions::mutable_data(int index) {
  // @@protoc_insertion_point(field_mutable:bilibili.community.service.dm.v1.Expressions.data)
  return _impl_.data_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expression >*
Expressions::mutable_data() {
  // @@protoc_insertion_point(field_mutable_list:bilibili.community.service.dm.v1.Expressions.data)
  return &_impl_.data_;
}
inline const ::bilibili::community::service::dm::v1::Expression& Expressions::_internal_data(int index) const {
  return _impl_.data_.Get(index);
}
inline const ::bilibili::community::service::dm::v1::Expression& Expressions::data(int index) const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.Expressions.data)
  return _internal_data(index);
}
inline ::bilibili::community::service::dm::v1::Expression* Expressions::_internal_add_data() {
  return _impl_.data_.Add();
}
inline ::bilibili::community::service::dm::v1::Expression* Expressions::add_data() {
  ::bilibili::community::service::dm::v1::Expression* _add = _internal_add_data();
  // @@protoc_insertion_point(field_add:bilibili.community.service.dm.v1.Expressions.data)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::bilibili::community::service::dm::v1::Expression >&
Expressions::data() const {
  // @@protoc_insertion_point(field_list:bilibili.community.service.dm.v1.Expressions.data)
  return _impl_.data_;
}
...
inline int64_t Period::_internal_start() const {
  return _impl_.start_;
}
inline int64_t Period::start() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.Period.start)
  return _internal_start();
}
inline void Period::_internal_set_start(int64_t value) {
  
  _impl_.start_ = value;
}
inline void Period::set_start(int64_t value) {
  _internal_set_start(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.Period.start)
}
...
inline int64_t Period::_internal_end() const {
  return _impl_.end_;
}
inline int64_t Period::end() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.Period.end)
  return _internal_end();
}
inline void Period::_internal_set_end(int64_t value) {
  
  _impl_.end_ = value;
}
inline void Period::set_end(int64_t value) {
  _internal_set_end(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.Period.end)
}
...
// int32 value = 1;
inline void PlayerDanmakuSeniorModeSwitch::clear_value() {
  _impl_.value_ = 0;
}
inline int32_t PlayerDanmakuSeniorModeSwitch::_internal_value() const {
  return _impl_.value_;
}
inline int32_t PlayerDanmakuSeniorModeSwitch::value() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.PlayerDanmakuSeniorModeSwitch.value)
  return _internal_value();
}
inline void PlayerDanmakuSeniorModeSwitch::_internal_set_value(int32_t value) {
  
  _impl_.value_ = value;
}
inline void PlayerDanmakuSeniorModeSwitch::set_value(int32_t value) {
  _internal_set_value(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.PlayerDanmakuSeniorModeSwitch.value)
}
...
// .bilibili.community.service.dm.v1.SubtitleType type = 7;
inline void SubtitleItem::clear_type() {
  _impl_.type_ = 0;
}
inline ::bilibili::community::service::dm::v1::SubtitleType SubtitleItem::_internal_type() const {
  return static_cast< ::bilibili::community::service::dm::v1::SubtitleType >(_impl_.type_);
}
inline ::bilibili::community::service::dm::v1::SubtitleType SubtitleItem::type() const {
  // @@protoc_insertion_point(field_get:bilibili.community.service.dm.v1.SubtitleItem.type)
  return _internal_type();
}
inline void SubtitleItem::_internal_set_type(::bilibili::community::service::dm::v1::SubtitleType value) {
  
  _impl_.type_ = value;
}
inline void SubtitleItem::set_type(::bilibili::community::service::dm::v1::SubtitleType value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:bilibili.community.service.dm.v1.SubtitleItem.type)
}
...
template <> struct is_proto_enum< ::bilibili::community::service::dm::v1::SubtitleType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::bilibili::community::service::dm::v1::SubtitleType>() {
  return ::bilibili::community::service::dm::v1::SubtitleType_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_danmaku_2eproto
